        ...
        groupButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (((DefaultListModel<String>) list.getModel()).size() > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "No Users Online!");
                }
            }
        });
                                ...
                                public void mouseClicked(MouseEvent e) {
                                    ...
                                    if (dChooser.showOpenDialog(chatPanel) == JFileChooser.APPROVE_OPTION) {
                                        try {
                                            ...
                                            fos.write(data);
                                            fos.close();
                                            JOptionPane.showMessageDialog(chatPanel, "File downloaded successfully!");
                                        } catch (IOException e1) {
                                            JOptionPane.showMessageDialog(chatPanel, "Failed to download file!");
                                        }
                                    }
                                }
                            });
